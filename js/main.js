...
/* harmony import */ var _components_init_yandexmap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/init-yandexmap */ "./src/js/components/init-yandexmap.js");
/* harmony import */ var _components_init_yandexmap__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_init_yandexmap__WEBPACK_IMPORTED_MODULE_2__);
...
document.addEventListener('DOMContentLoaded', function () {
  let center = [55.76965401273346, 37.63676449999999];
...
let btnOpen = document.querySelector('[data-search-open]');
let formSearch = document.querySelector('[data-search]');
let input = document.querySelector('[data-search-input]');
let btnClose = document.querySelector('[data-search-close]');
btnOpen.addEventListener('click', function () {
  formSearch.classList.add('search--active');
  // btnOpen.setAttribute('aria-expanded', true);

  if (formSearch?.classList.contains('search--active')) {
    btnOpen?.setAttribute('aria-expanded', 'true');
    btnOpen?.setAttribute('aria-label', 'Закрытьформу поиска');
  } else {
